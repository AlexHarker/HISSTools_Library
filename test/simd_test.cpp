...
int main(int argc, const char * argv[])
{
    ...
    simd_type<float, 1> vf0(values_f);
    simd_type<double, 1> vd0(values_d);
    simd_type<float, 4> vf1(values_f);
    simd_type<double, 2> vd1(values_d);
    simd_type<float, 8> vf2(values_f);
    simd_type<double, 4> vd2(values_d);
